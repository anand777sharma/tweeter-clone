    ...
    <div>
      ...
      <div className="card border-0 " >
        ...
        <ul className="list-group overflow-auto border-0" style={{ height: "67vh" }}>
          <Link className='text-decoration-none text-center' to="/home" ><li className="list-group-item border-0 fs-5 mt-1"><i className="fas fa-home fa-lg pe-2"></i>Home</li> </Link>

          <button className='border-0 btn btn-lignt btn-lg text-left' onClick={() => viewProfile(auth.user?._id)}><li className="list-group-item border-0 fs-5 mt-1"><i className="fas fa-user fa-lg pe-2"></i>Profile</li></button>
